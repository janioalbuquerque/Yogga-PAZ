...
<body>
    ...
    <div class="d-flex flex-grow-1">
        ...
        <a class="navbar-brand ml-4" href="#">
            <h4>Yogga<span class="text-dark">&PAZ</span></h4>
        </a>
    ...
    <div class="collapse navbar-collapse flex-grow-1 text-right" id="myNavbar7">
        <ul class="navbar-nav ml-auto flex-nowrap">
            <li class="nav-item">
                <a href="#" class="nav-link text-light font-1 font-italic">Home</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link text-light font-1 font-italic">Serviços</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link text-light font-1 font-italic">Sobre</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link text-light font-1 font-italic">Contato</a>
            </li>
        </ul>
    </div>
</nav>
		  ...
		  <div class="row row-cols-2">
		    ...
		    <div class="col-6 card-2 ">
		    	<div class="avatar-section1">
				    ...
				    <ul>
				    	<li>Previne dores e doenças</li>
				    	<li>Reduz o estresse</li>
				    	<li>Aumenta a flexibilidade</li>
				    	<li>Emagrece e tonifica os músculos</li>
				    	<li>Aumenta a flexibilidade</li>
				    	<li>Ajuda a dormir melhor</li>
				    	<li>Pode ser feito em qualquer lugar</li>
				    </ul>
				  </div>
